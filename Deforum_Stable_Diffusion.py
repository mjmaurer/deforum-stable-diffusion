...
vid_prompt = ENV.get("VID_PROMPT", "a pile of orange-brown tree branches and leaves in forest foilage, high detail, trippy, psychedelic")
...
def DeforumAnimArgs():
    ...
    strength_schedule = f"0: (1), {switch_frame - strength_build}: (1), {switch_frame - 1}: (0.55), {switch_frame + 200}: (0.6)" # {switch_frame}: (0.7), {switch_frame + 200}: (0.55)" #@param {type:"string"}
